...
def _reduce_bootstrap_notes(model: object, merged: str) -> str | None:
    ...
    system = SystemMessage(
        content=(
            ...
            "do not invent departments. Note **cross-section hand-offs** when the text implies dependencies between teams. "
            "Also use ## Cross-cutting constraints for org-wide risks, metrics, or policies "
